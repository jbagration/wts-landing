...
import connectorLine1 from '../../assets/connector-line-2-mobile.svg';
import connectorLine2 from '../../assets/connector-line-1-mobile.svg';
...
const TabletHowWeWork = () => {
  ...
  return (
    <><div className="how-we-work-container" id="reviews">
      ...
      <div className="steps-container how-we-work-container">

        ...
        {slides.map((slide, index) => (
          <div className="slide" key={index}>
            <div className="first-slide-content">
              ...
              <img src={slide.imageTablet} alt={slide.alt}/>
<img src={symbolsOutlineImage} alt="Symbols" className="image-symbol" onClick={() => handleSymbolsImageClick(slide.imageModal)}/>
  ...
  <Slider {...secondSettings}>
    {slides.map((slide, index) => (
      <div className="slide" key={index} style={{ backgroundImage: `url(${slide.imageTablet})` }}>
...
export default TabletOurWorkSection;
        ...
        <div className="top">
          <div className="left">
            <div className='footer-brand-names'>
              <div className="brand-name-footer brand-name-white">
          ...
          <div className="right">
            ...
            <div className="texts">
              <p className="text">Режим работы: пн-пт 09:00-18:00</p>
              <p className="text ">Номер телефона: <a className='menu-list-icon-text-pointer' href="tel:+79289566198">+7 (928) 956-61-98</a></p>
              <p className="text">Email: <a className='menu-list-icon-text-pointer' href="mailto:webteamstorm@gmail.com">webteamstorm@gmail.com</a></p>
            </div>
          </div>
        </div>

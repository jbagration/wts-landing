...
import rightArrowIcon from '../../assets/form-arrow-to-the-right-mini.svg';
import leftArrowIcon from '../../assets/form-arrow-to-the-left-mini.svg';
import '../../styles/OrderDevelopment.css';

const TabletOrderDevelopment = () => {
  ...
  const handleFormSubmit = async (event) => {
    ...
    if (!name.trim() || !phone.trim()) {
      ...
      formData.append('project', 'Проект'); 
    ...
    <div className="order-background" id="order-development">
      ...
      {showSuccess && <SuccessMessage onClose={() => setShowSuccess(false)} />} 
        <div className="order-section-title">
          ...
          <div className="order-section-title-h2">
          <h2>Еще остались</h2>
          <h2>вопросы?</h2>
          </div>
...
export default TabletOrderDevelopment;
